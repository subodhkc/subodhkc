...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    name: "llmverify",
    tagline:
      "Local-first LLM verification and guardrails. Prompt-injection checks, PII redaction, hallucination risk signals, JSON repair, and runtime monitoring.",
    kind: "package",
    status: "stable",
    glyph: "brackets",
    meta: "npm · MIT · v1.6.1",
  ...
  },
  {
    ...
    name: "AI AppSec",
    tagline:
      "Evidence-backed AppSec for AI applications and agents. 122 detectors, 79 security checks, coverage receipts, proof-of-fix, and MCP integration.",
    kind: "oss",
    status: "stable",
    glyph: "shield",
    meta: "OSS · MIT · v0.1.0",
    primary: {
      label: "Explore AI AppSec",
      href: "/products/ai-appsec",
      type: "launch",
    },
    secondary: { label: "GitHub", href: "https://github.com/subodhkc/ai-appsec", type: "github" },
  },
  {
    id: "llmverify-py",
    name: "llmverify-py",
  ...
  },
  {
    ...
    tagline:
      "Catch cross-tenant leaks before production. 57 deterministic rules for tenant boundaries across multi-tenant SaaS and MCP server code.",
    kind: "oss",
    status: "stable",
    glyph: "shield",
    meta: "OSS · MIT · v2.0.0",
    primary: {
      label: "Explore Tenant Isolation",
