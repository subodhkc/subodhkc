export default function StructuredData() {
  ...
  const professionalServiceSchema = {
    ...
    name: 'Subodh KC - AI Advisor & AI Systems Architect',
    description:
      'AI advisory and AI systems architecture for leaders, founders, and technical teams. Ongoing AI advisory, fractional AI strategy, opportunity assessment, production architecture, governance, and security review. Former Sr. Program Manager, HP Inc. with production AI systems experience.',
  ...
  const softwareApplicationSchemas = [
    ...
    },
    {
      ...
      description: 'MIT-licensed local-first LLM verification for prompt injection, PII redaction, hallucination risk signals, JSON repair, and runtime monitoring. Zero telemetry on free tier.',
    ...
    },
    {
      ...
      description: 'Evidence-backed AppSec for AI applications and agents. MIT-licensed security scanner for AI/LLM application code with 122 detectors, 79 security checks, coverage receipts, proof-of-fix, and MCP integration.',
    ...
    },
    {
      ...
      description: 'Static analysis scanner for multi-tenant SaaS and MCP server code. 57 deterministic rules for tenant isolation, IDOR, RLS, caches, storage, and MCP boundaries. MIT licensed, local, CI-ready, and MCP v2 compatible.',
