...
const SYSTEMS = [
  {
    ...
    desc: "Evidence-bound assurance for consequential AI.",
    proves: "Evaluated scope, action and access analysis, evidence coverage, explicit unknowns, and bounded decision receipts.",
