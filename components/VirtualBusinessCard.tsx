...
NOTE:Enterprise AI Advisor & AI Systems Architect
END:VCARD`
  ...
  const shareCard = async () => {
    const shareData = {
      title: 'Subodh Kumar Kc - Enterprise AI Advisor & AI Systems Architect',
      text: 'Enterprise AI Advisor & AI Systems Architect\n\nConnect with me:',
      url: 'https://subodhkc.com'
    }
              ...
              <Card className="relative shadow-2xl border-2">
                ...
                <CardContent className="p-6 space-y-4">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">Enterprise AI Advisor & AI Systems Architect</p>
                  </div>
                  ...
                  <div className="space-y-3 pt-2">
                    ...
                    <a href="mailto:admin@subodhkc.com" className="flex items-center gap-3 p-2 rounded-lg hover:bg-secondary transition-colors">
                      <Mail className="h-5 w-5 text-primary flex-shrink-0" />
                      <span className="text-sm">admin@subodhkc.com</span>
                    </a>
