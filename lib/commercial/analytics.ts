...
export type ConversionEventName =
  ...
  // AI Work Order funnel
  | 'work_order_intake_started'
  | 'work_order_intake_completed'
  | 'work_order_auth_required'
  | 'work_order_membership_required'
  | 'work_order_resume_after_auth'
  | 'work_order_resume_after_membership'
  | 'work_order_scope_classified'
  | 'work_order_scope_review_required'
  | 'work_order_scope_accepted'
  | 'work_order_checkout_started'
  | 'work_order_payment_completed'
  | 'work_order_fulfillment_completed'
  | 'work_order_fulfillment_failed'
  ...
  | 'work_order_scope_draft_saved'
  | 'work_order_scope_sent'
  | 'work_order_update_published'
  | 'work_order_artifact_published'
  | 'work_order_split'
  | 'work_order_owner_approval_requested'
  | 'work_order_started'
  | 'work_order_in_review'
  | 'work_order_needs_client_input'
  | 'work_order_awaiting_scope'
  | 'work_order_awaiting_approval'
  | 'work_order_awaiting_owner_approval'
  | 'work_order_ready_for_checkout'
  | 'work_order_payment_pending'
  | 'work_order_paid'
  | 'work_order_scoped'
  | 'work_order_in_progress'
  | 'work_order_cancelled'
  | 'work_order_refunded'
  | 'advisor_question_work_order_recommended'
  | 'advisor_seat_assigned'
  | 'advisor_seat_removed'
