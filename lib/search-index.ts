...
const staticPages: StaticPage[] = [
  ...
  { title: 'AI Opportunity & Workflow Assessment', description: 'Focused $500 assessment of one opportunity and one workflow. Delivers an AI Automation Blueprint.', href: '/ai-automation', category: 'Service', keywords: 'ai opportunity assessment ai workflow assessment ai automation blueprint buy configure build recommendation workflow analysis' },
