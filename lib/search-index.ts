...
const staticPages: StaticPage[] = [
  ...
  { title: 'Contact', description: 'Decision-led intake for diagnostics, executive AI advisory, systems architecture, assurance, speaking, or collaboration', href: '/contact', category: 'Page', keywords: 'contact decision intake enterprise ai advisor systems architect assurance' },
  { title: 'Strategic Diagnostic Intensives', description: 'Expose hidden opportunity, constraints, operating friction, value leakage, and decision conflict before committing resources', href: '/diagnostics', category: 'Service', keywords: 'strategic diagnostic ai opportunity constraint executive decision operating friction value leakage' },
  { title: 'AI Systems Architecture & Implementation', description: 'Production architecture for agents, RAG, voice, data, integrations, permissions, controls, and operating handoff', href: '/services', category: 'Service', keywords: 'ai systems architecture implementation agents rag voice integrations authority production' },
  ...
  { title: 'AI Advisor for Business', description: 'Human advisory connecting emerging AI capability, organizational context, technical reality, and decision consequence.', href: '/ai-advisor', category: 'Service', keywords: 'ai advisor for business human advisory ai signal organizational context decision evidence' },
  ...
  { title: 'Executive AI Advisory', description: 'Independent judgment for consequential, interconnected AI decisions.', href: '/advisory', category: 'Service', keywords: 'executive ai advisory ai strategy advisor ai architecture review vendor evaluation build buy roadmap operating model' },
  { title: 'HAIEC', description: 'High Assurance In Every Consequence. Evidence-bound assurance for consequential AI.', href: '/solutions/haiec', category: 'Solution', keywords: 'haiec high assurance every consequence ai action assurance evaluated scope evidence capability authority decision receipt' },
