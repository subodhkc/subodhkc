        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <Card id="services">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <p><strong className="text-foreground">Advisory Subscriptions:</strong> AI advisory services delivered under self-service subscriptions with applicable Service Schedules. The <a href="/service-terms/ai-advisor-for-business" className="text-primary hover:underline">AI Advisor for Business Service Terms</a> apply to $99/month subscriptions (up to 3 service seats). The <a href="/service-terms/fractional-ai-advisor" className="text-primary hover:underline">Fractional AI Advisor Service Terms</a> apply to $1,250/month subscriptions (up to 5 service seats). Organization membership is not limited to the service seat count. Checkout captures acceptance of the applicable Service Schedule version.</p>
              <p><strong className="text-foreground">AI Work Order:</strong> A $500 one-time scoped engagement delivering one defined outcome, available through an active AI Advisor or Fractional AI Advisor relationship. Scope is agreed before work begins. See the <a href="/ai-automation" className="text-primary hover:underline">AI Work Order page</a> for details.</p>
          ...
          <Card id="ip">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <p><strong className="text-foreground">Frameworks:</strong> Governance frameworks published on this site (CSM, HAIEC) may have separate licensing terms. Some frameworks and tools are published under open-source licenses with their own terms. Refer to their respective documentation.</p>
