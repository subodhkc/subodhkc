    ...
    <>
      ...
      <Section className="pt-8" id="layer-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-sm text-muted-foreground">For a detailed look, see the <Link href="/secure-enterprise-rag-architecture" className="text-primary font-medium hover:underline">Secure Enterprise RAG Architecture Guide</Link>.</p>
        </div>
      </Section>
      ...
      <Section className="pt-8" id="haiec">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-base text-foreground/90">The <Link href="/blog/haiec-modular-ai-governance-framework" className="text-primary font-medium hover:underline">HAIEC modular governance framework</Link> is positioned as an integration, assessment, and evidence layer - not as a replacement for the laws, standards, auditors, or certification bodies.</p>
      ...
      <Section className="pt-8" id="related-resources">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <Grid cols={2} className="gap-4">
            ...
            <Card><CardHeader><CardTitle className="text-base flex items-center gap-2"><ClipboardCheck className="h-4 w-4 text-primary" /> AI Vendor Due Diligence Checklist</CardTitle><CardDescription className="text-sm">complete vendor evaluation with industry-tiered approach and continuous monitoring.</CardDescription></CardHeader><CardContent><Link href="/ai-vendor-due-diligence-checklist" className="text-sm text-primary font-medium hover:underline inline-flex items-center gap-1">View checklist <ArrowRight className="h-3 w-3" /></Link></CardContent></Card>
            ...
            <Card><CardHeader><CardTitle className="text-base flex items-center gap-2"><Layers className="h-4 w-4 text-primary" /> AI Voice Agent Architecture</CardTitle><CardDescription className="text-sm">Complete production architecture behind Kestrel Voice - telephony, adaptive orchestration, RAG, tools, degradation, security, and evidence pipeline.</CardDescription></CardHeader><CardContent><Link href="/ai-voice-agent-architecture" className="text-sm text-primary font-medium hover:underline inline-flex items-center gap-1">Read article <ArrowRight className="h-3 w-3" /></Link></CardContent></Card>
            <Card><CardHeader><CardTitle className="text-base flex items-center gap-2"><Layers className="h-4 w-4 text-primary" /> Architecture Decision Master Sheet</CardTitle><CardDescription className="text-sm">Interactive 25-layer architecture decision sheet with AI development risks, CSM pillar mapping, documents per step, and Definition of Done for every layer.</CardDescription></CardHeader><CardContent><Link href="/architecture-decision-master-sheet" className="text-sm text-primary font-medium hover:underline inline-flex items-center gap-1">Open sheet <ArrowRight className="h-3 w-3" /></Link></CardContent></Card>
          </Grid>
        </div>
      </Section>
