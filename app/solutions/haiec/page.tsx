...
export const metadata = {
  ...
  description:
    'HAIEC is an evidence-first AI governance platform. EU AI Act compliance, NIST AI RMF, ISO 42001, NYC LL144 bias audits, runtime adversarial testing, and tamper-evident documentation with cryptographic verification. Features precision drift detection, Red Audit Kit, and Cognitive Systems Management.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'Evidence-first frameworks for behavioral AI governance. AI Governance Execution Framework, AI readiness assessments, and tamper-evident documentation for enterprise compliance.',
...
export default function HAIECPage() {
  ...
  const capabilities = [
    ...
    'Tamper-Evident Documentation Generation',
            ...
            <div className="space-y-6">
              <Card className="p-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Dashboards are not evidence. HAIEC generates tamper-evident documentation with cryptographic verification that stands up to regulatory scrutiny.
