...
.running{display:flex;align-items:center;justify-content:space-between;border-bottom:1px solid var(--line);padding-bottom:9px;margin-bottom:17px;color:var(--op-muted);font-size:8.2px;letter-spacing:.11em;text-transform:uppercase;font-weight:850}
...
.small{font-size:8.7px;line-height:1.4;color:var(--op-muted)}
...
.card h3{margin-bottom:6px}.card p{font-size:9.3px}.card ul{margin:8px 0 0;padding-left:16px}.card li{font-size:8.7px;line-height:1.4;margin:3px 0;color:var(--op-muted)}
...
.mock{border:1px solid #cdd8e2;border-radius:18px;background:#fff;overflow:hidden;box-shadow:0 12px 28px rgba(10,32,53,.08)}.mock-top{height:28px;background:#e9eef3;border-bottom:1px solid #d8e0e7;display:flex;align-items:center;gap:5px;padding:0 10px}.dot{width:7px;height:7px;border-radius:50%;background:#b7c0c9}.mock-body{padding:14px}.mock-row{display:grid;grid-template-columns:26px 1fr auto;gap:9px;align-items:center;padding:8px 0;border-bottom:1px solid #edf1f4}.mock-row:last-child{border-bottom:0}.mock-icon{width:26px;height:26px;border-radius:8px;background:var(--softblue);display:flex;align-items:center;justify-content:center;font-weight:900;color:var(--blue);font-size:8px}.mock-row b{font-size:8.5px;color:var(--navy)}.mock-row span{font-size:7px;color:var(--op-muted)}.pill{border-radius:999px;padding:4px 7px;background:var(--softteal);color:var(--teal);font-size:6px;font-weight:900}
.status{font-size:6.8px;font-weight:900;letter-spacing:.09em;text-transform:uppercase;color:var(--teal)}
.four{display:grid;grid-template-columns:1fr 1fr;gap:12px}.mini{border-radius:14px;border:1px solid var(--line);padding:13px;background:#fff}.mini .icon{width:30px;height:30px;border-radius:10px;background:var(--softblue);color:var(--blue);display:flex;align-items:center;justify-content:center;font-weight:900;margin-bottom:8px}.mini h3{font-size:14px;margin-bottom:4px}.mini p{font-size:8.3px;color:var(--op-muted)}
.article-list{display:grid;grid-template-columns:1fr 1fr;gap:12px}.article{border:1px solid var(--line);background:#fff;border-radius:14px;padding:14px}.article .type{font-size:6.8px;color:var(--blue);text-transform:uppercase;letter-spacing:.12em;font-weight:900}.article h3{font-size:15px;margin:5px 0}.article p{font-size:8.4px;color:var(--op-muted)}
.contact-grid{display:grid;grid-template-columns:1.35fr .65fr;gap:20px;align-items:center}.qrbox{border:1px solid var(--line);background:#fff;border-radius:18px;padding:14px;text-align:center}.qrbox img{width:150px;height:150px}.qrbox p{font-size:7.5px;color:var(--op-muted);margin-top:8px}
/* Cover */
...
<div style="display:grid;grid-template-columns:1.15fr 2fr .8fr;gap:10px;padding:8px 0;border-bottom:1px solid var(--line);align-items:center"><b style="font-size:9.2px;color:var(--navy)">Precision Drift Detector</b><p class="small" style="font-size:8.4px">Early-warning methods for model behavioral drift before it surfaces in outputs.</p><span class="tag teal" style="justify-self:start">Research / filing</span></div>
