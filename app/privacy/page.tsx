        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <Card id="information-collect">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <p><strong className="text-foreground">Commercial Services (AI Advisor for Business, AI Opportunity & Workflow Assessment, Fractional AI Advisor, Security Reviews):</strong> When you purchase a subscription or service, we collect your name, email, company name, and payment metadata. Payment details are processed by Stripe and we never store your full card number or banking details. For security reviews, we collect scope information including product name, tech stack, application type, and staging access details. For the AI Opportunity & Workflow Assessment, we collect qualification responses about your business objective, workflow problem, and systems involved.</p>
          ...
          <Card id="payments">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <p><strong className="text-foreground">One-Time Purchases:</strong> For one-time purchases (AI Opportunity & Workflow Assessment, Security Reviews), we store the transaction ID and purchase status to grant permanent access to the purchased service.</p>
