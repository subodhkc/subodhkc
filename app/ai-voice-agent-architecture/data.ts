...
export const multiChannelFeatures = [
  ...
  { title: 'WebRTC', desc: 'Browser-based calling via Twilio Client. A prebind session binds the tenant ID before the device connects, so that deterministic tenant resolution for browser-initiated calls. This enables click-to-call from the dashboard and web-based phone functionality.' },
]
