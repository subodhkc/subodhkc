...
import { StaffManagementClient } from '@/components/app/school-pickup/StaffManagementClient'
...
export default async function StaffPage({
  ...
  if (!user) redirect(`/login?next=/app/${orgSlug}/school-pickup/${siteSlug}/staff`)
