...
import { CredentialsClient } from '@/components/app/school-pickup/CredentialsClient'
...
export default async function CredentialsPage({
  ...
  if (!user) redirect(`/login?next=/app/${orgSlug}/school-pickup/${siteSlug}/credentials`)
