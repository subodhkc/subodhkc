...
import { CsvImportClient } from '@/components/app/school-pickup/CsvImportClient'
...
export default async function CsvImportPage({
  ...
  if (!user) redirect(`/login?next=/app/${orgSlug}/school-pickup/${siteSlug}/students/import`)
