...
export async function POST(req: NextRequest) {
    ...
    return NextResponse.json(
      {
        ...
        message: 'This organization already has an active AI Advisor Desk subscription.',
        workspaceUrl: `/app/${organization.slug}/advisor-desk`,
      },
      { status: 409 }
    )
  }
  ...
  const successUrl = `${siteUrl}/app/${organization.slug}/advisor-desk?checkout=success&offer=${offerKey}`
