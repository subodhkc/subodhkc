...
import { getWorkOrder, listDeliverables } from '@/lib/commercial/work-orders'

export const runtime = 'nodejs'
export const dynamic = 'force-dynamic'

/**
 * GET /api/commercial/work-orders/[workOrderId]/deliverables?orgSlug=<slug>
 * List deliverables for a Work Order (client-visible only for non-admins).
 */
export async function GET(
  ...
  const deliverables = await listDeliverables(workOrderId, ctx.isPlatformAdmin)
