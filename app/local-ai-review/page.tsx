    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : 'Something went wrong. Please text 682-224-9904 or email admin@subodhkc.com and mention "Local AI Review."'
      )
    } finally {
            ...
            <Card className="text-center p-8 mt-6">
              ...
              <div className="text-left max-w-md mx-auto space-y-3 mb-6">
                {[
                  ...
                  'Expect an email from admin@subodhkc.com - check your spam folder if you don\'t see it.',
                ].map((item, i) => (
              ...
              <div className="bg-primary/5 rounded-lg p-4 mb-6">
                <p className="text-sm text-muted-foreground">
                  Tip: Save <span className="font-medium text-foreground">admin@subodhkc.com</span> to your contacts
