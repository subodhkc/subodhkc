...
import {
  ...
  Volume2, PhoneCall, Gauge, Fingerprint, Layers, Settings,
} from 'lucide-react'
...
const faqs = [
  ...
  { q: 'Does Kestrel Voice provide an API?', a: 'Yes. Kestrel includes dashboard APIs, tenant-scoped server integration keys, call and appointment data access, analytics, and webhooks for supported events including call completion, appointment booking, and urgent call routing.' },
      ...
      <Section id="related-resources" className="pb-4">
        <div className="max-w-4xl mx-auto space-y-4">
          ...
          <Grid cols={3} gap="md">
            ...
            <Link href="/kestrel-voice-ai-receptionist-platform">
              <Card className="h-full hover:shadow-lg transition-all duration-300 hover:-translate-y-1 cursor-pointer">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center">
