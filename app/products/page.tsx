...
const products: Product[] = [
  ...
  // Open Source / Packages
  {
    ...
    description: 'Local-first LLM verification and guardrails. Prompt-injection checks, PII redaction, hallucination risk signals, JSON repair, and runtime monitoring. MIT licensed, zero telemetry.',
    iconName: 'Shield',
    status: 'OPEN SOURCE · v1.6.1',
    statusColor: 'bg-blue-500/10 text-blue-500',
    category: 'Open Source / Packages',
    features: ['Prompt injection checks', 'PII redaction', 'Hallucination risk signals', 'Zero telemetry'],
    cta: 'View Package',
  },
  {
    name: 'AI AppSec',
    href: '/products/ai-appsec',
    description: 'Evidence-backed AppSec for AI applications and agents. 122 detectors, 79 security checks, coverage receipts, proof-of-fix, and MCP integration. MIT licensed.',
    iconName: 'Shield',
    status: 'NEW · v0.1.0',
    statusColor: 'bg-green-500/10 text-green-500',
    category: 'Open Source / Packages',
    features: ['122 detectors', '79 security checks', 'Coverage receipts', 'MCP v2 integration'],
    cta: 'Explore AI AppSec',
  },
  {
    name: 'MCP Tenant Isolation',
    href: '/products/mcp-tenant-isolation',
    description: 'Catch cross-tenant leaks before production. 57 deterministic rules for tenant boundaries across multi-tenant SaaS and MCP server code. SARIF output, GitHub Action, MCP v2.',
    iconName: 'Lock',
    status: 'NEW · v2.0.0',
    statusColor: 'bg-green-500/10 text-green-500',
    category: 'Open Source / Packages',
    features: ['57 deterministic rules', '15 MCP-specific rules', 'SARIF output', 'MCP v2 server'],
    cta: 'Explore Tenant Isolation',
  },
  {
