...
export default function Home() {
  ...
  const expertise = [
    {
      ...
      description:
        'Expert guidance on AI strategy, implementation, and governance. From concept to production, I help organizations navigate the AI landscape with confidence.',
    },
    {
      icon: Shield,
      title: 'AI Security & Compliance',
      description:
        'Comprehensive security assessments and regulatory compliance frameworks. EU AI Act, NIST AI RMF, ISO 42001, and NYC Local Law 144 expertise.',
    },
    {
      icon: Zap,
      title: 'AI Voice Infrastructure',
      description:
        'Building production-ready voice AI systems. From customer service automation to intelligent call routing and voice-enabled applications.',
    },
    {
      icon: TrendingUp,
      title: 'SaaS Development & Architecture',
      description:
        'Full-stack SaaS solutions with modern tech stacks. Scalable, secure, and compliant applications for enterprise and startups.',
    },
  ]

  const achievements = [
    'Father of 2 daughters | Family-focused professional',
    ...
    'Available for AI Consultation & Advisory',
    'Expert in AI Security, Compliance & Voice Infrastructure',
  ]
  ...
  return (
    <>
      <Hero
        subtitle="AI Compliance Architect | SaaS Developer | Family Man"
        title={
          <>
            Turn AI Pilots Into
            <br />
        ...
        description="Father of two daughters. Fortune 50 AI Compliance Architect. I build the compliance architecture that lets you move fast—legally. Available for AI Consultation, Security/Compliance Advisory, and AI Voice Infrastructure projects."
        imageSrc="/profile-photo.jpeg"
        imageAlt="Subodh KC - AI Compliance Architect and SaaS Developer"
        layout="split"
      >
        <motion.div
